      ...
      <div className="navigation">
                ...
                <div className="keyword-menu" style={{ display: "block" }}>
                  <ul>
                    {relatedKeywords.map((keyword, index) => (
                      <li
                        onClick={() => {
                          window.location.href = `/products/${keyword.item_id}`;
                        }}
                        key={index}
                      >
                        {keyword.item_name}
        ...
        <div className="cartUserIcons">
          {accessToken ? (
            <a
              href={
                position == "seller" ? "/admin_seller" : "/user#/user/orders"
              }
            >
            ...
            <ul className="nav-list">
              <li className="category-dropdown">
                ...
                <div className="category-menu">
                  <ul>
                    <li>
                      <a href="/categories/dessert">디저트</a>
                    </li>
                    <li>
                      <a href="/categories/salad">식재료</a>
                    </li>
                    <li>
                      <a href="/categories/free">양념/소스</a>
                    </li>
                    <li>
                      <a href="/categories/drink">차,음료</a>
                    </li>
                  </ul>
                </div>
              </li>
              <li>
                <a href="/master">장인소개</a>
              </li>
              <li>
                <a href="https://www.instagram.com/alter__mall/">건강정보</a>
              </li>
              <li>
                <a href="/ranking">랭킹</a>
              </li>
              ...
              <ul className="nav-list">
                <li className="category-dropdown">
                  ...
                  <div className="category-menu">
                    <ul>
                      <li>
                        <a href="https://altermall.shop/categories/dessert">
                          디저트
                        </a>
                      </li>
                      <li>
                        <a href="https://altermall.shop/categories/salad">
                          샐러드
                        </a>
                      </li>
                      <li>
                        <a href="https://altermall.shop/categories/free">
                          락토프리
                        </a>
                      </li>
                      <li>
                        <a href="https://altermall.shop/categories/drink">
                          음료
                        </a>
                      </li>
                    </ul>
                ...
                <li>
                  <a href="https://altermall.shop/submit">납품</a>
                </li>
                <li>
                  <a href="https://www.instagram.com/alter__mall/">건강정보</a>
                </li>
        ...
        <div className="mobileContainer">
          <div className="">
            ...
            >
              <FontAwesomeIcon
                icon={faX}
                className={`delBtn ${isMenuOpen ? "open" : ""}`}
              />
                  ...
                  <ul>
                    ...
                    <li>
                      <div className="listContainer">
                        ...
                        <a href="https://altermall.shop/master">장인소개</a>
                      </div>
                    </li>
                    <div style={{ borderBottom: "0.5px dashed #ccc" }}></div>
                    <li>
                      <div className="listContainer">
                        ...
                        <a href="https://www.instagram.com/alter__mall/">
                          건강정보
                        </a>
                      </div>
                    </li>
                    ...
                    <li>
                      {" "}
                      <div className="listContainer">
                        <img className="icon" src="/rank.png" />
                        <a href="/ranking">랭킹</a>
                      </div>
                    </li>
                    <div style={{ borderBottom: "0.5px dashed #ccc" }}></div>
            ...
            <ul className="nav-list">
              ...
              <li>
                <a
                  ...
                  href="https://www.instagram.com/alter__mall/"
                >
                  건강정보
                </a>
              </li>
