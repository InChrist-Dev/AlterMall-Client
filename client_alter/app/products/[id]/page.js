  ...
  return (
    <div>
        ...
        <div className={styles.productDetails}>
                ...
                <div className={styles.healthRating}>
                  {[1, 2, 3, 4, 5].map((apple) => (
                    <FontAwesomeIcon
                      ...
                      icon={faAppleWhole}
                      style={{
                        color: apple <= healthRating ? "#4CAF50" : "#ccc",
                      }}
          ...
          <div className={styles.imageContainer}>
            ...
            {data.img2 ? (
              <img
                className={styles.itemImg}
                src={data.img2 ? `https://altermall.site/${data.img2}` : ""}
              />
            ) : (
              ""
            )}
            {data.img3 ? (
              <img
                className={styles.itemImg}
                src={data.img3 ? `https://altermall.site/${data.img3}` : ""}
              />
            ) : (
              ""
            )}
            {data.img4 ? (
              <img
                className={styles.itemImg}
                src={data.img4 ? `https://altermall.site/${data.img4}` : ""}
              />
            ) : (
              ""
            )}
      ...
      <div>
        ...
        <div className={styles.detail}>
          {data.desc4 ? (
            <img src={`https://altermall.site/${data.desc4}`} />
          ) : (
            ""
          )}
        </div>
        <div className={styles.detail}>
          {data.desc5 ? (
            <img src={`https://altermall.site/${data.desc5}`} />
          ) : (
            ""
          )}
        </div>
